...
import uet.vnu.quizlet.ClassData.User;
...
public class SignUpActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    emailEditText = (EditText) findViewById(R.id.emailForgotEditText);
            ...
            .addOnCompleteListener(SignUpActivity.this, new OnCompleteListener<AuthResult>() {
              ...
              public void onComplete(@NonNull Task<AuthResult> task) {
                ...
                if (!task.isSuccessful()) {
                  Toast.makeText(SignUpActivity.this, "Đăng kí thất bại" + task.getException(),
                      Toast.LENGTH_SHORT).show();
                } else {
                  String userName = usernameEditText.getText().toString();
                  User user = new User(auth.getCurrentUser().getUid(), userName,
                      email, getResources().getString(R.string.default_avatar_uri));
